...
from blender_utils.object_ops import cleanup_scene, look_at, make_object, rotate, set_location
...
def render_box(z_angle, image_path):
    ...
    bpy.ops.object.light_add(type="AREA", align="WORLD", location=(0, 0, 2), scale=(1, 1, 1))
    ...
    vertices_uvz = [
        world_to_camera_view(scene, camera, v.co) for i, v in enumerate(box.data.vertices) if i in corner_ids
    ]
